...
function App() {
  ...
  const nav = [{ path: "/", label: "Search" }, { path: "/explore", label: "Explore" }, { path: "/insights", label: "Insights" }, { path: "/trails", label: "Trails" }, { path: "/bookmarks", label: `Bookmarks ${profile.bookmarks.length}` }, { path: "/compare", label: `Compare ${profile.compare.length}` }];
